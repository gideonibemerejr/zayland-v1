...
export function getSayItToMyFace() {
	return [
		{
			link: "https://open.spotify.com/album/7tjSf86xdLIhw3m0XN2SOC?si=oXTrmsDoQG-QrZsT_iIaMw",
			title: "Spotify",
			iconSrc: spotify,
		},
		{
			link: "https://listen.tidal.com/album/210663892",
			title: "Tidal",
			iconSrc: tidal,
		},
		{
			link: "https://music.apple.com/us/album/say-it-to-my-face-single/1602464451",
			title: "Apple Music",
			iconSrc: appleMusic,
		},
	];
}
export function getWishWeHadAChance() {
	return [
		// {
		...
		// },
		{
			link: "https://open.spotify.com/album/0jssXOs10jD0LyNiYCFhvP?si=8Ar0iXY6Rh6jvyJd4l0ayQ",
			title: "Spotify",
			iconSrc: spotify,
		},
		{
			link: "tidal.com/browse/album/201788051",
			title: "Tidal",
			iconSrc: tidal,
		},
		// {
		...
		// },
		{
			link: "https://music.apple.com/us/album/wish-we-had-a-chance-single/1591089620",
			title: "Apple Music",
			iconSrc: appleMusic,
		},
	];
...
export function getGetAwayPlatforms() {
	return [
		...
		// },
		{
			link: "https://music.apple.com/us/album/get-away/1552227772?i=1552227773",
			title: "Apple Music",
			iconSrc: appleMusic,
		},
	];
